...
mixin _$UserResponse {
 ...
 String get id; String get email;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;@JsonKey(name: 'email_verified') bool get emailVerified; String? get name; String? get image;
...
@useResult
$Res call({
 String id, String email,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'updated_at') DateTime updatedAt,@JsonKey(name: 'email_verified') bool emailVerified, String? name, String? image
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'email_verified')  bool emailVerified,  String? name,  String? image)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserResponse() when $default != null:
return $default(_that.id,_that.email,_that.createdAt,_that.updatedAt,_that.emailVerified,_that.name,_that.image);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String email, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'email_verified')  bool emailVerified,  String? name,  String? image)  $default,) {final _that = this;
switch (_that) {
case _UserResponse():
return $default(_that.id,_that.email,_that.createdAt,_that.updatedAt,_that.emailVerified,_that.name,_that.image);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String email, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'updated_at')  DateTime updatedAt, @JsonKey(name: 'email_verified')  bool emailVerified,  String? name,  String? image)?  $default,) {final _that = this;
switch (_that) {
case _UserResponse() when $default != null:
return $default(_that.id,_that.email,_that.createdAt,_that.updatedAt,_that.emailVerified,_that.name,_that.image);case _:
  return null;
...
class _UserResponse implements UserResponse {
  const _UserResponse({required this.id, required this.email, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'email_verified') this.emailVerified = false, this.name, this.image});
...
/// Create a copy of UserResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? email = null,Object? createdAt = null,Object? updatedAt = null,Object? emailVerified = null,Object? name = freezed,Object? image = freezed,}) {

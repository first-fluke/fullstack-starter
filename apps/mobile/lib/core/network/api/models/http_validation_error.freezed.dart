...
bool operator ==(Object other) {
  final _this = this as HttpValidationError;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HttpValidationError&&const DeepCollectionEquality().equals(other.detail, _this.detail));
}
...
int get hashCode {
  final _this = this as HttpValidationError;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.detail));
}

@override
String toString() {
  final _this = this as HttpValidationError;
  return 'HttpValidationError(detail: ${_this.detail})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? detail = freezed,}) {
  return _then(HttpValidationError(
...
class _HttpValidationError implements HttpValidationError {
  const _HttpValidationError({ List<ValidationError>? detail}): _detail = detail;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _HttpValidationError&&const DeepCollectionEquality().equals(other.detail, _detail));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(_detail));
}

...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RegisterRequest&&(identical(other.email, _this.email) || other.email == _this.email)&&(identical(other.password, _this.password) || other.password == _this.password)&&(identical(other.name, _this.name) || other.name == _this.name));
}
...
String toString() {
  final _this = this as RegisterRequest;
  return 'RegisterRequest(email: ${_this.email}, password: ${_this.password}, name: ${_this.name})';
}
...
class _RegisterRequest implements RegisterRequest {
  const _RegisterRequest({required this.email, required this.password, this.name});

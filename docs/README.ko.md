...
| **모바일** | Flutter 3.44.8, Riverpod 3, go_router 17, Firebase Crashlytics, Fastlane |
...
> 전체 오케스트레이션 워크플로우는 [`../.agents/workflows/work.md`](../.agents/workflows/work.md)를 참조하세요.
...
# 모든 런타임 일괄 설치 (Node 26, Python 3.12, Flutter 3, bun, uv, Terraform)
mise install
```
